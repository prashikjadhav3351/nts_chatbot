...
def process_with_groq(question, detail_level="brief"):
    ...
    prompt_template = PromptTemplate.from_template(
        ...
        **Response:**
        Please provide a complete {detail_level} response based on the provided data only (no external sources).

        - If there is a related URL, include it in a clean format without brackets, parentheses, or any trailing punctuation.
        ...
        Example:
        - First topic or point.
        - Second topic or point with a URL: yourlink.com
        """
)
